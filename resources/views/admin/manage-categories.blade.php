        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    ...
                    <div class="page-header-subtitle">Lista de categorías registradas</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-xl px-4 mt-n10">
    ...
    <div class="card mb-4">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            Categorías
            <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#addCategoryModal">
                <i class="fa-solid fa-user-plus me-2"></i>
                Añadir Categoría
            </button>
        </div>

        @if (session('mensaje') == 'La categoría se ha creado correctamente.')
        ...
        @elseif (session('mensaje') == 'La categoría se ha actualizado correctamente.')
        <div class="card-header" id="cardHeader" id="cardHeader">
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropstart">
                                    <button class="btn btn-transparent-dark p-1" type="button" id="dropdownMenuButton_{{ $category->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fa-solid fa-ellipsis-vertical me-2"></i>
                                        Opciones
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton_{{ $category->id }}">
                                        <li>
                                            <button type="button" class="dropdown-item text-gray-700" data-bs-toggle="modal" data-bs-target="#updateCategoryModal_{{ $category->id }}">
